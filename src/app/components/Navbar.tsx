    ...
    <>
      ...
      <nav className="bg-white fixed w-full z-20 border-b border-gray-300 shadow-sm">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center max-w-screen-xl">
          ...
          {/* Desktop Menu */}
          <div className="hidden md:flex items-center space-x-8 px-6 py-2 rounded-md bg-white backdrop-blur-sm relative z-10 shadow-md border border-gray-900">
            {[
              "Explore",
              "Resources",
              "DSA",
              ...
              return (
                <Link
                  key={item}
                  href={path}
                  className={`relative text-lg font-medium transition-all duration-300 whitespace-nowrap ${
                    pathname === path
      ...
      {/* Sidebar (Mobile Menu) */}
      <div
        className={`fixed top-0 left-0 h-full w-4/5 max-w-xs bg-white shadow-lg transform transition-transform duration-300 z-30 border-r border-gray-300 ${
